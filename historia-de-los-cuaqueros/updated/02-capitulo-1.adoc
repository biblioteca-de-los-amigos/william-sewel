...
footnote:[A lo largo de esta historia, _papado_ se refiere a las doctrinas,
...
la palabra _profesantes_ se refiere a los que profesan fe en Cristo.]
...
footnote:[En ese tiempo, hacer una _sangría_ era una práctica común entre los médicos,
...
footnote:[La palabra _escrúpulos_ aparece a menudo a lo largo
